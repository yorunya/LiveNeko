...
## Finetune your model
The base model is the `google/vit-base-patch16-224`, download it from hugging face use as default model, or finetune it with yourself. Tere is a example by using `sample.py` and `train.py`. you can download my simple  fine-fune model for vtuber `Ace Taffy` from model/ dir.
